        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if(names[int(cls)]=="car" or names[int(cls)]=="motorcycle"):
                        ...
                        if save_img or save_crop or view_img:  # Add bbox to image
                            ...
                            if result:
                                ...
                                for line in result:
                                    belongsto = ''
                                    try:
                                        number = int(''.join(filter(str.isdigit, line[1])))
                                        if(number>=1000):

                                            # Readfile
                                            file1 = open('vehicles_list.txt', 'r')
                                            Lines = file1.readlines()

                                            for line in Lines:
                                                result = line.split(' ')
                                                print(int(result[0].strip()),number)
                                                
                                                if(int(result[0].strip())==number):
                                                    belongsto = result[1]

                                                    text_lines.append(result[0]+' '+belongsto)
                                    except:
